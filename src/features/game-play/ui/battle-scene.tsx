    ...
    <div className="flex h-full flex-col overflow-y-auto">
      ...
      <div className="bg-surface-subtle flex flex-col gap-4 p-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="whitespace-pre-wrap leading-relaxed">{data.background}</p>
        </div>
      </div>

      {/* 진행도 */}
      <div className="border-b border-gray-200 bg-bg p-4">
        ...
        <div className="bg-gray-200 relative mt-2 h-2 w-full overflow-hidden rounded-full">
          <div
